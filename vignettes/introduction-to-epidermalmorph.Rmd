...
cells are light grey (170) and pavement cells are white (255). This can be done using straightforward software (e.g. ImageJ, MS Paint) - the important thing is that there is no anti-aliasing applied. 
